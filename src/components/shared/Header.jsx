        ...
        <div className='max-w-6xl mx-auto'>
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end">
                    ...
                    {!isAdmin && !isSurveyor && !isProUser && <Link to="/payment"><a className="btn btn-warning mr-2 p-2 btn-sm">Upgrade</a></Link>}

                    {
                        user ?
                            ...
                            :
                            <Link to="/login"><a className="btn btn-primary ml-2 p-2 btn-sm">Login</a></Link>
                    }
                </div>
            </div>
        </div>
